...
async function createXdvipdfmxModule(moduleArg = {}) {
...
function findWasmBinary() {
  ...
  if (Module['locateFile']) {
    return locateFile('xdvipdfmx.wasm');
  }

  // Use bundler-friendly `new URL(..., import.meta.url)` pattern; works in browsers too.
  return new URL('xdvipdfmx.wasm', import.meta.url).href;
...
export default createXdvipdfmxModule;
