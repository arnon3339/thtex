...
async function createBibTeXModule(moduleArg = {}) {
...
function findWasmBinary() {
  ...
  if (Module['locateFile']) {
    return locateFile('bibtex.wasm');
  }

  // Use bundler-friendly `new URL(..., import.meta.url)` pattern; works in browsers too.
  return new URL('bibtex.wasm', import.meta.url).href;
...
export default createBibTeXModule;
